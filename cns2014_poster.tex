...
\vspace{1em}
\begin{center}
\includegraphics[width=0.8\linewidth]{figures/precision_plot.eps}
...
\begin{center}
\includegraphics[width=0.8\linewidth]{figures/cmu_all_results.eps}
\captionof{figure}{Figure caption}
\end{center}
...
\headerbox{Method}{name=method,column=0,below=objectives,bottomaligned=conclusion}{ % This block's bottom aligns with the bottom of the conclusion block
We selected methods that make a range of representational assumptions.
\begin{center}
i\input{tables/table_assumptions.tex}
\end{center}
