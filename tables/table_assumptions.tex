\begin{tabular}{L{.35\textwidth} c c c c c}
\toprule
Assumption & Uni & SL & L & R & SOS \\
\midrule
\Assumption{2} & \checkmark & \checkmark & & & \checkmark$^\dagger$ \\
\Assumption{3} & \checkmark & \checkmark & & & \checkmark$^\dagger$ \\
\Assumption{1} & \checkmark & & & & \\
\Assumption{4} & \checkmark & & & & \\
\Assumption{5} &  & & \checkmark & & \checkmark \\
\Assumption{6} & \checkmark & & & \checkmark & \\
\bottomrule
\end{tabular}
